...
export const MASTER_POSITIONS: MasterPosition[] = [
  ...
  },
  {
    ...
    name: 'Mandor Panen',
    level: 'staff',
    description: 'Mandor koordinator tim panen',
    baseSalary: 4800000,
  ...
  },
  {
    ...
    name: 'Operator Mesin',
    level: 'karyawan',
    description: 'Operator alat berat dan mesin',
    baseSalary: 3800000,
    allowanceJabatan: 700000,
    allowanceSkill: 500000,
    isActive: true,
    employeeCount: 18,
  },
  {
    ...
    level: 'staff',
    description: 'Manajer divisi administrasi',
    baseSalary: 10000000,
  ...
  },
  {
    ...
    level: 'staff',
    description: 'Manajer divisi keuangan',
    baseSalary: 12000000,
